...
# MoolaWeb.Endpoint.init/2 when load_from_system_env is
...
config :moola, Moola.GDAXSocket,
  ...
  ticker_period: 15.0,
  product_ids: ["ETH-USD", "BTC-USD", "LTC-USD", "ETH-BTC", "BCH-USD", "LTC-BTC"]
...
# start per endpoint:
#
#     config :moola, MoolaWeb.Endpoint, server: true
#
